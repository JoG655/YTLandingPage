import { playlists, subscriptions } from "../data/App";
...
export function Sidebar() {
  ...
  return (
    <>
      <aside
        className={twMerge(
          "scrollbar-hidden sticky top-0 ml-1 flex flex-col overflow-y-auto pb-4 lg:flex",
          isLargeOpen && "lg:hidden",
        )}
      >
  ...
  return (
    <a
      ...
      className={twMerge(
        ...
        isActive && "bg-neutral-100 font-bold hover:bg-secondary",
      )}
    >
